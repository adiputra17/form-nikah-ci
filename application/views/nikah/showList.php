...
<center>
	...
	<!-- </a> -->
		...
		<p align="center"><b>Tatacara perkawinan dilangsungkan</b></p>
		 <?php 
			$sql =  $this->db->query('SELECT * FROM lain WHERE lainid='.$id.''); 
...
<!-- <div class="row"> -->
	...
	<div class="col-md-4">
		...
		<tbody>
			<?php 
				$sql =  $this->db->query('SELECT * FROM pengantinpria WHERE priaid='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
	...
	<div class="col-md-4">
		...
		<tbody>
			<?php 
				$sql =  $this->db->query('SELECT * FROM pengantinwanita WHERE wanitaid='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<tbody>
			<?php 
				$sql =  $this->db->query('SELECT * FROM bapakpria WHERE pria2id='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
	...
	<div class="col-md-4">
		...
		<tbody>
			 <?php 
				$sql =  $this->db->query('SELECT * FROM bapakwanita WHERE wanita2id='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<tbody>
			<?php 
				$sql =  $this->db->query('SELECT * FROM ibupria WHERE pria3id='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
	...
	<div class="col-md-4">
		...
		<tbody>
			 <?php 
				$sql =  $this->db->query('SELECT * FROM ibuwanita WHERE wanita3id='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
...
<div class="row">
	...
	<div class="col-md-4">
		...
		<tbody>
			<?php 
				$sql =  $this->db->query('SELECT * FROM saksipria WHERE pria4id='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
	...
	<div class="col-md-4">
		...
		<tbody>
			 <?php 
				$sql =  $this->db->query('SELECT * FROM saksiwanita WHERE wanita4id='.$id.''); 
				foreach($sql->result_array() as $row):
			?>
	...
	<div class="container">
		<table class="table borderless" style="border: none;">
			<tr style="border: none;">
				...
				<?php 
				$sql =  $this->db->query('SELECT tanggal FROM lain WHERE lainid='.$id.''); 
				foreach($sql->result_array() as $row):
				?>
